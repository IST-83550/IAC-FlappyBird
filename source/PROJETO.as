...
Posicao_tubos				TAB 	13	  ;primeiros 2 bits=posicao da porta (linha)
							  ;outros 2 = posicao do tubo(coluna)
...
Ciclo_Limpa_tubos:			MOV M[CURSOR], R7
					...
					CMP R2, R7			;compara a posicao do cursor atual com a posicao da porta
									;(que e a primeira posicao livre)
